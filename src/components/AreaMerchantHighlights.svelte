...
<section id="boosted">
	<!-- prettier-ignore -->
	<div class="w-full rounded-3xl border border-statBorder dark:border-white/75 dark:bg-white/10">
		<!-- prettier-ignore -->
		<h3
			class="border-b border-statBorder p-5 text-center text-lg font-semibold text-primary md:text-left dark:border-white/75 dark:text-white"
		>
			Boosted Merchants
		</h3>
