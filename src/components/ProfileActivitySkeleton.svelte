...
>
	<div class="items-center space-y-2 md:flex md:space-y-0 md:space-x-5">
		...
		<!-- event placeholder -->
		<div
			class="mx-auto h-[38px] w-full animate-pulse rounded-xl bg-link/50 md:mx-0 md:h-[30px] md:w-[400px]"
		/>
	</div>

	<!-- time ago placeholder -->
	<div class="mx-auto h-[38px] w-32 animate-pulse rounded-xl bg-link/50 md:mx-0 md:h-[30px]" />
</div>
