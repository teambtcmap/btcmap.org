...
<!-- desktop header -->
<header
  class="relative z-30 mx-auto hidden w-[1200px] items-center justify-between py-5 xl:flex"
>
  ...
  <div class="space-x-4">
    ...
    <button on:click={() => (showMobileMenu = !showMobileMenu)}>
      <Icon
        ...
        type="mobile-nav"
      />
      <span class="font-semibold text-mobileMenu uppercase dark:text-white"
        >Menu</span
      >
    </button>
  </div>
