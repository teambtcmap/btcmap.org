...
{#if $taggingIssues}
	<OutClick excludeQuerySelectorAll="#tagging-issues" on:outclick={closeModal}>
		<div
			...
			class="center-fixed border-mapBorder z-[2000] max-h-[90vh] w-[90vw] overflow-auto rounded-xl border bg-white p-6 text-left shadow-2xl md:h-[400px] md:w-[430px] dark:bg-dark"
		>
