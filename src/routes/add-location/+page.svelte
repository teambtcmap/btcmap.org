...
<svelte:head>
  ...
  <meta
    ...
    content="https://btcmap.org/images/og/add.png"
  />
</svelte:head>
...
{#if !submitted}
  ...
  <p
    class="mt-10 text-center text-lg font-semibold text-primary md:text-xl dark:text-white"
  >
  ...
  <div class="mt-16 pb-20 md:pb-32 lg:flex lg:justify-between lg:gap-10">
    <section
      id="form"
      class="mx-auto w-full lg:w-1/2 lg:border-r lg:border-input lg:pr-10"
    >
      <div class="mx-auto max-w-xl">
        ...
        <p class="mb-10 w-full text-justify text-primary dark:text-white">
          Fill out the following form and one of our volunteer community members
          will add your location to the map. <InfoTooltip
        ...
        >
          ...
          <fieldset>
            <legend class="mb-2 block font-semibold"
              >Select accepted payment methods</legend
            >
            {#if noMethodSelected}
          ...
          <div>
            ...
            {#if source === "Other"}
              <p class="my-2 text-justify text-sm">
                How did you verify this information? Please provide as much
                detail as possible.
              </p>
              <textarea
                disabled={!captchaSecret || !mapLoaded}
          ...
          <div>
            ...
            <p class="mb-2 text-justify text-sm">
              If we have any follow-up questions we will contact you in order to
              add this location successfully. To speed up the process please
              check your spam folder in case it ends up there.
            </p>
            <input
              disabled={!captchaSecret || !mapLoaded}
              required
      ...
      <div class="lg:flex lg:justify-start">
        <div class="mx-auto max-w-xl text-primary dark:text-white">
          ...
          <p class="mb-10 w-full text-justify md:text-left">
            Contribute changes directly to OSM - like a 😎 boss. Who needs forms
            anyway.
          </p>
          <img
