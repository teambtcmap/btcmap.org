...
<svelte:head>
  ...
  <meta
    property="og:image"
    content="https://btcmap.org/images/og/add-community.png"
  />
...
{#if !submitted}
  ...
  <section
    id="add-community"
    class="mx-auto mt-16 w-full pb-20 md:w-[600px] md:pb-32"
  >
    <h2
      class="mb-5 text-center text-3xl font-semibold text-primary dark:text-white"
    >
      Add Community
    </h2>

    <p class="mb-5 w-full text-center text-primary dark:text-white">
      Please fill out this form to submit a community application. This is a
      great way to grow bitcoin adoption in your area, have some fun, and maybe
      even make some friends along the way. <InfoTooltip
    ...
    >
      <div class="space-y-2">
        <label for="location-picker" class="block font-semibold"
      ...
      <div>
        ...
        <p class="mb-2 text-sm">
          We will use the avatar from your social link or the country's flag
          your community is located in if an icon is not provided.
        </p>
        <input
          disabled={!captchaSecret}
          type="url"
      ...
      <div>
        ...
        >
        <p class="mb-2 text-sm">
          You need to provide at least one method for people to join your
          community.
        </p>
      ...
      <div>
        ...
        >
        <p class="mb-2 text-sm">
          A way to get in touch with the community leader if we have any
          questions.
        </p>
        <input
          required
      ...
      <div>
        ...
        >
        <p class="mb-2 text-sm">
          Is this community part of an organization? Would you like to be
          associated with a specific language? Etc.
        </p>
      ...
      <div>
        <div class="mb-2 flex items-center space-x-2">
          <label for="captcha" class="font-semibold"
            >Bot protection <span class="font-normal">(case-sensitive)</span
            ></label
          >
          {#if captchaSecret}
