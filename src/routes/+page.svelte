...
<div class="street-map bg-teal dark:bg-dark">
  ...
  <div class="relative mx-auto w-10/12 xl:w-[1200px]">
    <section
      id="hero"
      class="items-center justify-between pt-10 pb-20 xl:flex xl:pt-0"
    >
      <div class="mx-auto w-full xl:mx-0 xl:w-[500px]">
          ...
          {#each $apps as app (app.link)}
            ...
            >
              ...
              <a
                ...
                aria-label={app.type === "Web"
                  ? "Open web app"
                  : `Download for ${app.type}`}
        ...
        <h2
          class="text-center text-xl font-semibold text-primary xl:text-left dark:text-white"
        >
          We use
          <a
            ...
            >OpenStreetMap</a
          >
          to tag places that accept bitcoin and we display those merchants in our
          beautiful apps.
          <br /><br />
