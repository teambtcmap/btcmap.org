...
>
  <div class="items-center space-y-1 md:flex md:space-y-0 md:space-x-2">
    <Icon
      ...
      w="20"
      h="20"
      class="animate-pulse text-xl text-link/50"
    />

    <div>
      <span
        class="mr-1 inline-block h-6 w-32 animate-pulse rounded bg-link/50"
      />
      ...
      <span
        class="mx-auto block h-12 w-40 animate-pulse rounded bg-link/50 md:mx-0 md:h-5"
      />
    </div>
  </div>
  ...
  <div>
    <Icon
      ...
      w="16"
      h="16"
      class="animate-pulse text-link/50"
    />
  </div>
</div>
