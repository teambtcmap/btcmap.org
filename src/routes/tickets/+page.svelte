...
<main class="mt-10 mb-20 space-y-10">
  ...
  >
    Tickets up for grabs from our noob forms! Anyone can help add or verify
    location submissions and help vet communities.
  </h2>
  ...
  <p class="text-center text-xl text-primary lg:text-left dark:text-white">
    More information on how to get involved can be found in our <a
      ...
      >Tagging Merchant Instructions</a
    >.
  </p>
  ...
  <section id="tickets">
    ...
    >
      <div
        class="p-5 text-center text-2xl font-semibold text-primary dark:text-white"
      >
        {#each ticketTypes as type (type)}
          <button
            class="mx-auto block w-40 border border-link py-2 md:inline {type ===
            'Add'
