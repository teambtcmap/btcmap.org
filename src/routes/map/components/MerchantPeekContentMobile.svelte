...
<div class="space-y-3">
  ...
  <div class="flex items-start justify-between gap-3">
    <div class="min-w-0 flex-1">
      {#if hasName}
        <h3
          class="truncate text-lg leading-tight font-bold text-primary dark:text-white"
        >
          {merchant.name}
        </h3>
      {:else if isLoading}
  ...
  <!-- Swipe hint -->
  <div
    class="flex items-center justify-end border-t border-gray-200 pt-3 dark:border-white/10"
  >
