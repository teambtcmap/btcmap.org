    ...
    <div class="flex items-start gap-3">
      ...
      >
        <Icon
          w="22"
          h="22"
          icon={merchant.icon || "currency_bitcoin"}
          type="material"
        />
      </div>
      ...
      <div class="min-w-0 flex-1">
        ...
        <div class="flex items-center gap-1">
          ...
          {:else}
            <span
              class="truncate text-sm font-medium text-primary dark:text-white"
              >Unknown</span
            >
          {/if}
        </div>
        ...
        {#if enrichedData}
          <div class="mt-1.5 flex flex-wrap items-center gap-2 text-xs">
            ...
            {/if}
            <span
              class="flex items-center gap-1 text-gray-500 dark:text-white/60"
            >
              <Icon
                w="12"
                h="12"
                icon={isVerified ? "check" : "warning"}
                type="material"
              />
