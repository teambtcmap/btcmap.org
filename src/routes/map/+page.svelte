<script lang="ts">
        ...
        onMount(async () => {
                if (browser) {
                                ...
                                onAdd: () => {
                                        ...
                                        if (theme === 'light') {
                                                searchButton.onmouseenter = () => {
                                                        // @ts-expect-error - img element src property access
                        ...
                        // @ts-expect-error - Leaflet internal _controlCorners property access
                        map._controlCorners['topcenter'] = leaflet.DomUtil.create(
                                'div',
                                'leaflet-top leaflet-center',
                                // @ts-expect-error - Leaflet internal _controlContainer property access
                                map._controlContainer
                        );

                        // @ts-expect-error - extending Leaflet Control dynamically
                        ...
                        // @ts-expect-error - dynamically added Search control
