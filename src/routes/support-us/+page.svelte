...
<svelte:head>
  ...
  <meta
    property="og:image"
    content="https://btcmap.org/images/og/support.png"
  />
...
<main class="my-10 space-y-10 text-center md:my-20">
  ...
  >
    BTCMap.org is a free and open source project (FOSS). We rely on donations
    and sponsorship to continue.
      ...
      >
        <div class="space-y-5">
          ...
          <p class="text-center text-xl text-primary dark:text-white">
            Scan or click to donate <br class="block md:hidden" /><strong
              class="lowercase">{network}</strong
            >
            <img
  ...
  <section id="supporters">
    ...
    <a
      ...
      class="text-link transition-colors hover:text-hover">Become a Sponsor</a
    >
