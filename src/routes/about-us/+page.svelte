...
<div class="bg-teal dark:bg-dark">
	...
	<div class="mx-auto w-10/12 xl:w-[1200px]">
		<main class="mb-20 mt-10 space-y-20 text-primary md:space-y-40 dark:text-white">
			...
			<section
				class="w-full justify-center space-y-10 rounded-xl bg-[#EBEFF2] p-5 md:p-10 lg:flex lg:space-x-10 lg:space-y-0 dark:bg-white/[0.15]"
			>
				<div class="lg:w-[475px]">
