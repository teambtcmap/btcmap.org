...
<main class="mt-10 mb-20 space-y-20 text-primary md:space-y-40 dark:text-white">
  <div class="space-y-5 text-center text-xl">
    ...
    <p class="mx-auto md:w-[600px]">
      BTC Map is a free and open source project powered by volunteer bitcoiners
      and bitcoin-friendly merchants around the world.
    </p>
  </div>

  <section
    class="w-full justify-center space-y-10 lg:flex lg:space-y-0 lg:space-x-10"
  >
    <div class="lg:w-[475px]">
      ...
      <div class="space-y-5">
        <p>
          Merchants are at the heart of BTC Map. These businesses are
          front-running the paradigm change and positioning themselves for
          continued success. Any merchant who accepts bitcoin can be listed on
          BTC Map.
        </p>
        <p>
  ...
  <section
    class="w-full space-y-10 rounded-xl bg-[#164E63] p-5 text-center text-white md:p-10"
  >
    <h2 class="text-3xl font-semibold">Shadowy Supertaggers</h2>

    <p class="mx-auto lg:w-[650px]">
      Shadowy Supertaggers are people who power this project. They are
      volunteers who selflessly take the time to update business locations with
      new information. Without them, BTC Map would not be sustainable!
    </p>
  ...
  >
    <div class="lg:w-[475px]">
      ...
      <div class="space-y-5">
        <p>
          Bitcoin communities help drive global adoption by onboarding new users
          locally!
        </p>
        <p>
  ...
  >
    <div class="lg:w-[475px]">
      ...
      <p>
        Anybody can contribute to BTC Map in many different ways. If you would
        like to get involved please don't hesitate and come join the fun!
      </p>
    </div>
  ...
  >
    <div class="lg:w-[475px]">
      ...
      <div class="space-y-10">
        <p>
          <strong>Igor</strong> is a long time bitcoiner, mapper, and digital nomad
          living abroad. He created BTC Map as an Android application and the project
          has since gained worldwide momentum from there. He now also maintains all
          of the backend infrastructure for the project.
        </p>
        <p>
          <strong>Nathan</strong> is a tech entrepreneur turned pleb-at-large. He
          brought the core team together to accelerate app development. Having built,
          sold, invested in and advised tech businesses over the years he is now focused
          on bitcoin, building BTCMap.org, gamertron.net and delivering bitcoin education
          for kids.
        </p>
        <p>
          A self-taught Web Developer, <strong>secondl1ght</strong> dove head first
          down the bitcoin rabbit hole and left his fiat career to focus on bitcoin
          development full-time. He created and maintains the BTC Map web application,
          as well as an encrypted messaging app called Cipherchat, and works on lightning
          network tools at Amboss Technologies.
        </p>
        <p>
          <strong>Karnage</strong> is the lead designer on the web app and created
          the BTC Map brand. He has contributed to many high profile bitcoin open
          source projects. His mission is to help startup founders succeed and creates
          products to achieve this goal. Pixel-perfect product design every time.
          Get it shipped.
        </p>
      </div>
    </div>
    ...
    <div
      class="flex grid-cols-2 flex-wrap items-center justify-center gap-10 lg:grid"
    >
