...
<svelte:head>
  ...
  <meta
    ...
    content="https://btcmap.org/images/og/apps.png"
  />
</svelte:head>
...
<main class="my-10 space-y-10 text-center md:my-20">
  ...
  <h3 class="text-2xl font-semibold text-primary md:text-left dark:text-white">
    Official
  </h3>
  <section
    id="official-apps"
  ...
  <p class="text-center font-normal dark:text-white">
    Note: There is no Google Play option due to their excessive KYC requirements
    for developers.
  </p>
