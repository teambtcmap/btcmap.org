...
<main class="mt-10 mb-20 space-y-10">
  <div class="space-y-5 text-xl text-body dark:text-white">
    <h1
      class="text-4xl !leading-tight font-semibold text-primary md:text-5xl dark:text-white"
    >
      Privacy Policy
    </h1>
    <p>
  ...
  <div class="space-y-5 text-xl text-body dark:text-white">
    ...
    <ol class="ml-5 list-decimal space-y-2">
      ...
      <li>
        Some information including communities is not stored on OpenStreetMap
        but in the BTC Map database instead.
      </li>
    </ol>
    <p>
      Please refer to the privacy policies of each of these third parties to
      understand how your information is used there.
    </p>
    ...
    <p>
      By submitting information through one of our forms you are agreeing that
      this information will be used publicly.
    </p>
    ...
    <p>
      ...
      <a href={$socials.x} class="text-link transition-colors hover:text-hover"
        >@btcmap</a
      >
      X account.
    </p>
  ...
  <div class="space-y-5 text-xl text-body dark:text-white">
    ...
    <p>
      ...
      >
        Netlify
      </a> in order to see activity on BTC Map. For example, how many users are visiting
      the website and the performance.
    </p>
    <p>
      These analytics do not use any cookies or trackers. There is no personally
      identifiable information included. All of the data is anonymous and
      complies with the <a
  ...
  <div class="space-y-5 text-xl text-body dark:text-white">
    ...
    <p>
      It is good practice to protect your public IP address when surfing the
      web. The two most common methods to do this are:
    </p>
    <ol class="ml-5 list-decimal space-y-2">
      <li>
