...
$: latestTaggers = !!(supertaggers?.length && !elementsLoading);
</script>
...
<svelte:head>
  ...
  <meta
    property="og:image"
    content="https://btcmap.org/images/og/activity.png"
  />
...
<main class="mt-10 mb-20 space-y-10">
  ...
  >
    Shadowy Supertaggers don’t sleep. They are up all night, tagging away. The
    world we want is a tag away.
  </h2>
