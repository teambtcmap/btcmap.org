...
<svelte:head>
  ...
  <meta
    property="og:image"
    content="https://btcmap.org/images/og/supertagger.png"
  />
  <meta
    property="twitter:title"
    content="{username ? username + ' - ' : ''}BTC Map Supertagger"
  />
  <meta
  ...
  <section id="profile" class="space-y-8">
    ...
    <div class="space-y-1">
      ...
      >
        ...
        <span class="block">
          Mapping Since: {mappingSince
            ? format(new Date(mappingSince), "yyyy-MM-dd")
            : "-"}
        </span>
      </p>
      {#if username}
    ...
    <h2
      class="mx-auto w-full text-xl break-all text-body lg:w-[800px] dark:text-white"
    >
    ...
    <div class="flex flex-wrap items-center justify-center">
      ...
      {:else}
        {#each Array(3) as _, i (i)}
          <div class="mx-3 mb-6">
            <div
              class="mx-auto mb-1 h-24 w-24 animate-pulse rounded-full bg-link/50"
            />
