...
<svelte:head>
  ...
  <meta
    ...
    content="https://btcmap.org/images/og/verify.png"
  />
</svelte:head>
...
{#if !submitted}
  ...
  <section id="verify" class="mx-auto mt-16 w-full pb-20 md:w-[600px] md:pb-32">
    ...
    <p class="mb-10 w-full text-center text-primary dark:text-white">
      Please fill out the following form and one of our volunteer community
      members will update your location on the map. Did you know you can update
      this data yourself on <a
    ...
    >
      ...
      <div>
        <div class="flex items-center space-x-2">
          <label
            for="current"
            class="{!outdated ? 'cursor-pointer' : ''} font-semibold"
      ...
      <div>
        <label for="outdated" class="mb-2 block font-semibold"
          >Outdated information <span class="font-normal">(If applicable)</span
          ></label
        >
        <textarea
      ...
      <div>
        <label for="verify" class="mb-2 block font-semibold"
          >How did you verify this?</label
        >
        <textarea
