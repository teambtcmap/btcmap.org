    ...
    >
        ...
        <form class="space-y-4" on:submit={generateInvoice}>
          <legend>
            ...
            <p class="text-sm text-body dark:text-white">
              All comments are currently anonymous. We collect a small fee in
              sats as a spam protection measure.
            </p>
            <p class="text-sm text-body dark:text-white">
              Current fee: 500 sats
            </p>
          </legend>
          ...
          <div>
            <label
              for="comment"
              class="mb-2 block font-semibold text-primary dark:text-white"
              >Your comment</label
            >
            <textarea
              name="comment"
      ...
      {:else if stage === 1}
        ...
        >
          ...
          <PrimaryButton style="w-full rounded-xl p-3" on:click={closeModal}
            >Close</PrimaryButton
          >
        </InvoicePaymentStage>
      {:else}
