...
<svelte:head>
  ...
  <meta
    ...
    content="https://btcmap.org/images/og/badges.png"
  />
</svelte:head>
...
<main class="my-10 text-center md:my-20">
  ...
  <p class="mx-auto w-full text-lg text-primary lg:w-[700px] dark:text-white">
    You can earn badges for your BTC Map contributions that will be displayed on
    your profile. Have a badge idea? Let us know!
  </p>
